...
public class GameModel extends Observable {
    ...
    public void checkShipCrashed() {
        this.ship.isShipCrashed =  (this.peaks.peaksPoly.intersects(this.ship.getShape()) || !this.worldBounds.contains(this.ship.getShape()));
    }
    ...
    public void checkShipLanding() {
        ...
        this.ship.isShipLanding =  landingPadRect.intersects(this.ship.getShape());
        if(this.ship.isShipLanding) {
            this.ship.isShipCrashed = (this.ship.getSpeed() >= this.ship.getSafeLandingSpeed());
        }
    }
